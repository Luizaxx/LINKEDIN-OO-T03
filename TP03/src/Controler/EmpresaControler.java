...
public class EmpresaControler {
    ...
    public static void cadastrarEmpresa() {
        ...
        if (novaEmpresa != null) {
            ...
            JOptionPane.showMessageDialog(null,"Empresa cadastrada com sucesso!", "Sucesso", JOptionPane.PLAIN_MESSAGE);
        }
    }
    ...
    public static void editarNomeEmpresa(){       
        ...
        if (verificaCNPJ(cnpjDesejado)){
            for(Empresa empresa : empresas){
                if (empresa.getCnpj().equals(cnpjDesejado)) {
                    String novoNome = JOptionPane.showInputDialog(null,"Antigo nome cadastrado no cadastro da empresa: "+ empresa.getNome()+" \nDigite o novo nome:");
    ...
    public static void editarEmailEmpresa(){    
        ...
        if (verificaCNPJ(cnpjDesejado)){
            for(Empresa empresa : empresas){
                if (empresa.getCnpj().equals(cnpjDesejado)) {
                    String novoEmail = JOptionPane.showInputDialog(null,"Antigo email cadastrado no cadastro da empresa: "+ empresa.getEmail() + " \nDigite o novo email: ");
    ...
    public static void editarDataCriacaoEmpresa(){       
        ...
        if (verificaCNPJ(cnpjDesejado)){
            for(Empresa empresa : empresas){
                if (empresa.getCnpj().equals(cnpjDesejado)) {
                    String novaDataCriacao = JOptionPane.showInputDialog(null,"Antiga data de criação cadastrada no cadastro da empresa: "+ empresa.getDataNascimento() + " \nDigite a nova data de criação da empresa:");
    ...
    public static void editarEnderecoEmpresa(){       
        ...
        if (verificaCNPJ(cnpjDesejado)){
            for(Empresa empresa : empresas){
                if (empresa.getCnpj().equals(cnpjDesejado)) {
                    String novoEndereco = JOptionPane.showInputDialog(null, "Antigo endereço cadastrado no cadastro da empresa: "+ empresa.getEndereco() + " \nDigite o novo endereço: ");
    ...
    public static void editarTelefoneEmpresa(){       
        ...
        if (verificaCNPJ(cnpjDesejado)){
            for(Empresa empresa : empresas){
                if (empresa.getCnpj().equals(cnpjDesejado)) {
                    String novoTelefone = JOptionPane.showInputDialog(null, "Antigo telefone cadastrado no cadastro da empresa: "+ empresa.getTelefone() + " \nDigite o novo telefone:");
    ...
    public static void editarAreaAtuacaoEmpresa(){       
        ...
        if (verificaCNPJ(cnpjDesejado)){
            for(Empresa empresa : empresas){
                if (empresa.getCnpj().equals(cnpjDesejado)) {
                    String novaAreaAtuacao = JOptionPane.showInputDialog(null,"Antiga área de atuação cadastrada no cadastro da empresa: "+ empresa.getAreaAtuacao() + " \nDigite a nova área de atuação:");
    ...
    public static void editarCNPJEmpresa(){   
        ...
        if (verificaCNPJ(cnpjDesejado)){
            for(Empresa empresa : empresas){
                if (empresa.getCnpj().equals(cnpjDesejado)) {
                    String novoCNPJ = JOptionPane.showInputDialog(null, "Antigo CNPJ cadastrado no cadastro da empresa: "+ empresa.getCnpj() + " \nDigite o novo CNPJ:");
    ...
    public static Empresa lerDadosEmpresa(){
        ...
        while (!camposPreenchidos) {
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                if(algumCampoEmBranco(nomeField, emailField, dataNascimentoField, enderecoField, telefoneField, areaAtuacaoField, cnpjField) == false) {
                    camposPreenchidos = true;
                    ArrayList<OfertaEmprego> ofertasOfertadas = new ArrayList<OfertaEmprego>();

                    return new Empresa(nome, email, dataNascimento, endereco, telefone, areaAtuacao, cnpj, ofertasOfertadas);
                }else{
                    JOptionPane.showMessageDialog(null, "Preencha todos os campos antes de prosseguir.", "Aviso", JOptionPane.WARNING_MESSAGE);
                }
            }else{
